...
Shader "Unlit/TransparentIntersection"
{
	Properties
	{
		...
		_ZoneBoundaryColour( "Zone Boundary Colour", Color ) = ( 1.0, 1.0, 1.0, 1.0 )
	}
		SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag( v2f i ) : SV_Target
				{
					...
					fixed4 col = lerp( fixed4( 0.0f, 0.0f, 0.0f, 1.0 ), _ZoneBoundaryColour, intersection );
					return col;
				}
				ENDCG
			}
